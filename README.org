...
*** Precondition
Install git and sudo for further steps.
#+begin_src shell :results output silent :cache no /sudo::
su -
apt -y install git
apt -y install sudo
adduser [USER] sudo
...
sudo apt install -y qtile python3-psutil \
                          python3-pulsectl
...
*** Zen
Install through zen installer (on site), otherwise the keepassxc won't work
...
#+end_src
After install start inside DIR the jetbrains file

** Hardware
*** Xencelabs
Install drivers: https://www.xencelabs.com/us/support/download-drivers

* Gnome
** General
#+begin_src shell :results output silent :cache no :tangle no

# SET key to use AltGr for german
gsettings set org.gnome.desktop.interface enable-hot-corners false
gsettings set org.gnome.desktop.input-sources sources "[('xkb', 'us+altgr-intl')]"
gsettings set org.gnome.desktop.input-sources mru-sources "[('xkb', 'us+altgr-intl')]"
gsettings set org.gnome.desktop.input-sources xkb-options "['ctrl:nocaps']"


# Set input sources: US (AltGr intl) + Russian (standard)
gsettings set org.gnome.desktop.input-sources sources \
"[('xkb', 'us+altgr-intl'), ('xkb', 'ru')]"

# Ensure MRU matches exactly (prevents ghost layouts)
...
# (Optional) Ensure Alt+Shift switches layouts
...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom0/ command 'xdg-open https://'
...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom1/ command "emacsclient -c -a emacs -e '(eshell)' "
...
# --- Super+E -> Emacs (WITH TRAILING SPACE) ---
...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom2/ command 'emacsclient -c -a emacs '
